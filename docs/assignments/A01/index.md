...
For this part, I looked at two engineering portfolios online. I compared them based on how easy they were to use, how well they explained the work, whether they showed the design process, and how professional they looked.

---

## Portfolio 1: Elijah Young

**URL:** https://elijahhyoung.github.io/index.html

### Navigability

This portfolio is easy to move through because the projects are shown on the homepage. Each project has a title and picture, so it is easy to find what you are looking for. I think someone could find a project in less than 60 seconds.

### Reproducibility

The portfolio gives information about each project and shows pictures of the work. Some projects also include details about how they were built. There are still some missing calculations and dimensions, so another student may not be able to fully recreate every project.

### Evidence of Reasoning

The portfolio shows more than just the final product. It includes parts of the design and testing process. This helps show how the projects changed over time and how some design choices were made.

### Professional Tone

The website focuses on engineering work, projects, and experience. The writing is simple and technical. The layout also keeps the engineering projects as the main focus.

---

## Portfolio 2: Nhan Dang

**URL:** https://tranthunhan.github.io/

### Navigability

This portfolio is also easy to move through. The projects are separated into sections, and the homepage gives a quick idea of what the portfolio contains. A reader can find the different projects without going through many pages.

### Reproducibility

The portfolio includes CAD models, pictures, prototypes, and testing information. This helps explain how the projects were made. Some calculations and measurements are not shown, so more information would still be needed to completely recreate the work.

### Evidence of Reasoning

The portfolio shows some of the design process instead of only showing finished projects. It includes testing and changes that were made during the projects. This makes it easier to understand how the final designs were reached.

### Professional Tone

The website stays focused on mechanical engineering. The project descriptions are simple and the pictures help explain the work. The website looks like something that could be shown to a professor or employer.

---

## Portfolio Comparison

Both portfolios have things that I would like to use in my own portfolio. Elijah Young's portfolio makes the projects easy to find, while Nhan Dang's portfolio does a good job of showing CAD models, pictures, and testing.

For my own portfolio, I want to keep the website simple and easy to move through. I also want to include enough pictures, calculations, and explanations so another student can understand how I completed my work.
...
My homepage is meant to quickly show who I am and what is included in my engineering portfolio. I want a professor, student, or employer to be able to open the website and easily find my assignments.

I plan to keep the homepage simple with a short introduction and links to my work. I also want my projects to show some of the steps I used to reach my final answers instead of only showing the final result.

---

## 2. Intentional Customization

I changed the main color of my portfolio to a UNC Charlotte green.

I chose this color because it connects the portfolio to my school and gives the website a simple style of my own.

The color can also help make headings and links easier to see.

---

## 3. My Documentation Standard

For every assignment, I will show my important equations, assumptions, calculations, and design choices so another engineering student can understand how I reached my answer.
...
To me, defending an engineering decision means being able to explain why I chose one option instead of another.

Instead of saying that I picked something because I liked it better, I should be able to support my choice with calculations, testing, cost, materials, safety, or other engineering information.

Right now, I understand the basic idea of defending an engineering decision, but I am still learning how to do it well. I can use calculations to support an answer, but I need more practice comparing different choices and explaining why one choice works better than another.
