...
$$
Assumptions
The 800 lbf load is the worst-case static load.
The load transfers through the bracket in the direction shown on the FBDs.
The material is uniform 6061-T6 aluminum with no cracks or defects.
Direct shear failure is ignored because the assignment says to assume no failure from direct shear stress.
Shear deflection is ignored.
Feature A and Feature E are treated like cantilever beams.
Feature B and Feature D are treated like axial members.
Feature C is treated like a simply supported beam with a load in the center.
All calculated dimensions were rounded up to practical dimensions for the CAD model.
Sharp inside corners should have fillets added before manufacturing.
---
Stress Analysis
...
Feature A is a solid circular cantilever beam.
The 800 lbf force acts at the free end.
...
Feature B is an axial compression member with a constant rectangular cross section.
The 800 lbf force is centered on the web.
Bending and buckling are neglected for this first-pass design.
Free Body Diagram
...
Feature C is a simply supported rectangular beam.
The 800 lbf force is applied at the center.
Each support carries 400 lbf and the maximum bending moment occurs at the center.
Free Body Diagram
...
Feature D is an axial compression member with a constant rectangular cross section.
The 800 lbf force is centered on the rear web.
Bending and buckling are neglected for this first-pass design.
Free Body Diagram
...
Feature E is a rectangular cantilever beam.
The 800 lbf force acts at the free end.
Maximum bending stress occurs at the fixed end.
Free Body Diagram
![Feature D and E FBDs](images/fbd_feature_de.png)
...
References
MEGR 2156/2157 Design for Strength and Stiffness I assignment, Appendix A through E.
Oberg, Erik, et al. Machinery’s Handbook. ANSI/ASME Standard Limits and Fits, pages 646-660.
6061-T6 aluminum material properties used in the course design calculations.
